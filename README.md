...
```
With this, you have remotely connected to your Raspberry Pi! Any command you type out now will be ran into the Pi's terminal.\
The first command I recommand you type is to update your Raspberry Pi to the newest software version.
...
This is especially helpful because VNC also transmit keyboard and mouse events to the Pi, so you don't need more peripheral devices.
First, we must enable the VNC server on the Raspberry Pi. Enter the follow command already connected to the Raspberry Pi with SSH.
...
You can mess around with the applications already installed, like the minecraft they have preinstalled! 
